    ...
    <View style={styles.container}>
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.questionContainer}>
          <Text style={styles.titleText}>第 {currentQuestionIndex + 1} / {questions.length} 題</Text>
          <Text style={{
          margin: 5,
          ...FONTS.h4,
          fontWeight: 600,
        ...
        <View style={styles.progressBarContainer}>
            ...
            {questions.map((question, index) => (
                <Icon key={index} name={'remove-outline'} size={35} color={index === currentQuestionIndex ? 'black' : '#DADADA'} style={styles.progressIcon} />
            ))}
            </View>

                <Text style={styles.descriptionText}>{currentQuestion.questionText}</Text>
                <View style={{
                    justifyContent:'center',
                    alignContent:'center',
                }}>
                    <View style={{
                        ...
                        <TouchableOpacity key={index} style={styles.touchableborder} onPress={() => handleAnswer(option)}>
                    ...
                    <View style={{
                        ...
                        <Text style={{marginStart:-35}}>
                            完全無感
                        </Text>
                        <Text>
                            中等程度
                        </Text>
                        <Text style={{marginEnd:-35}}>
                            非常有感
                        </Text>
        ...
        <View style={styles.navigationContainer}>
          ...
          <TouchableOpacity
            ...
            <Text style={styles.nextText}>
                {currentQuestionIndex === questions.length - 1 ? "送出" : "下一題"}
            </Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
